...
class Args:
    def __init__(self,seed,enhance_llm) -> None:
        ...
        # Model name_encoder_dataset_enhanced dataset_model used for data enhancement
        # Training function parameters should include model name_encoder_dataset name_data set enhancement method_model used for data enhancement
