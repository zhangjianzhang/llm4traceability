...
class Args:
    def __init__(self,seed,enhance_llm) -> None:
        ...
        # Model name_encoder_data set_enhanced data set_model for data enhancement
...
result = pd.DataFrame(result).to_excel("/gemini/output/lopo_jina_result_record.xlsx",index=False)
